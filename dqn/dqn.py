...
class DQN(nn.Module):
    def __init__(self, input_shape, num_of_actions):
        ...
        # self.conv_reduced = nn.Conv2d(input_shape, 16, kernel_size=3, stride=2)
        # self.conv_reduced2 = nn.Conv2d(16, 16, kernel_size=3, stride=1)
    ...
    def forward(self, x):
        # conv_reduce_out1 = F.relu(self.batch_norm1(self.conv_reduced(x)))
        # conv_reduce_out2 = F.relu(self.batch_norm1(self.conv_reduced2(conv_reduce_out1)))
